set opt(data_rate)    0.08
set opt(max_backoff_slots) 2
set opt(packetsize)                      500
...
set opt(bit_rate)                     10000
set opt(encoding_efficiency)          1
set opt(guard_time)		      0.001 ;#0.00001
set opt(max_burst)                    1 ;#1
...
set opt(seed)	                	348.88
set opt(stop)	                	1215	;# simulation time
set opt(prestop)                        800 ;# time to prepare to stop
...
Mac/UnderwaterMac/SFAMA set guard_time_  $opt(guard_time)
Mac/UnderwaterMac/SFAMA set max_backoff_slots_  $opt(max_backoff_slots)
Mac/UnderwaterMac/SFAMA set max_burst_  $opt(max_burst)	
...
add-packet-header Common UWVB SFAMA LL
...
$god_ set_filename test_SF.data
...
$a_(0) set-filename test_SF.data
...
$a_(1) set-mactype 2
$a_(1) set-filename test_SF.data
...
$a_(2) set-mactype 2
$a_(2) set-filename test_SF.data
...
$a_(3) set-mactype 2
$a_(3) set-filename test_SF.data
...
$a_(4) set-mactype 2
$a_(4) set-filename test_SF.data
...
$a_(5) set-mactype 2
$a_(5) set-filename test_SF.data
...
$a_(6) set-mactype 2
$a_(6) set-filename test_SF.data
...
$a_(7) set-mactype 2
$a_(7) set-filename test_SF.data
...
$a_(8) set-mactype 2
$a_(8) set-filename test_SF.data
...
$a_(9) set-mactype 2
$a_(9) set-filename test_SF.data

set node_(10) [$ns_  node 10]
$god_ new_node $node_(10)
$node_(10) set X_  5500
$node_(10) set Y_  2500
$node_(10) set Z_  0
$node_(10) set-cx  5500
$node_(10) set-cy  2500
$node_(10) set-cz  0
...
$a_(10) set-mactype 2
$a_(10) set-filename test_SF.data

set node_(11) [$ns_  node 11]
$god_ new_node $node_(11)
$node_(11) set X_  5500
$node_(11) set Y_  1000
$node_(11) set Z_  0
$node_(11) set-cx  5500
...
$a_(11) set-mactype 2
$a_(11) set-filename test_SF.data
...
$node_(12) set Y_  3250
$node_(12) set Z_   0
$node_(12) set-cx  1700
$node_(12) set-cy  3250
$node_(12) set-cz  0
...
$ns_ at 15.1 "$node_(12) setdest 1700 1750 2.5"
...
$ns_ at 15.1 "$node_(13) setdest 4700 1750 2.5"
...
$a_(13) set-mactype 2
$a_(13) set-filename test_SF.data
