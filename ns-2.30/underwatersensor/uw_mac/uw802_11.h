 ...
 */
//#define DSSS_MaxPropagationDelay        0.2
int DSSS_MaxPropagationDelay=2;
// 0.000002 2us   XXXX

class PHY_MIB {
public:
    PHY_MIB(Macuw802_11 *parent);
    ...
    inline u_int32_t getHdrLen11() {
        return(getPLCPhdrLen() + offsetof(struct hdr_macuw802_11, dh_body[0])
                       + ETHER_FCS_LEN);
    }
...
/* ======================================================================
   ...
   ====================================================================== */
class Macuw802_11 : public UnderwaterMac {
