...
set ptype(uw802_11) 71\n\
set pvals(71) uw802_11\n\
set ptype(uw-staticrouting) 72\n\
set pvals(72) UW-StaticRouting\n\
set ptype(uw-message) 73\n\
set pvals(73) UW-Message\n\
set ptype(uw-aloha-ack) 74\n\
set pvals(74) UW-Aloha-ACK\n\
set ptype(uw_drouting) 75\n\
set pvals(75) uw_drouting\n\
set ptype(goal_req) 76\n\
set pvals(76) GOAL_REQ\n\
set ptype(goal_rep) 77\n\
set pvals(77) GOAL_REP\n\
set ptype(goal_ack) 78\n\
set pvals(78) GOAL_ACK\n\
proc ptype2val {str} {\n\
global ptype\n\
