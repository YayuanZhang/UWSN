...
\titleformat{\chapter}[block]{\normalfont\sSanhao\filcenter\fHei\bf}%
    {\sSanhao {第\CJKnumber{\thechapter}章}}{0.5em}{\sSanhao}
\titleformat{\section}[block]{\fHei \bf \sSihao}%
    {\sSihao \thesection}{0.5em}{}{}
\titleformat{\subsection}[block]{\fHei \bf \sHalfXiaosi}%
    {\sHalfXiaosi \thesubsection}{0.5em}{}{}
\titleformat{\subsubsection}[block]{\fHei \bf}%
    {\thesubsubsection }{0.5em}{}{}
...
% 后续文字可以自行修改
\chead{\sSanhao\raisebox{0.04cm}{\nwpulogo 西北工业大学} \fSong {\bf 本科毕业设计论文}}
%------------------------------------------------------------------------------%
